...
@section('content')
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-10 col-md-offset-1">
        <div class="panel panel-info">
          <div class="panel-heading"><strong>Oops, what a tragedy</strong></div>
          <div class="panel-body"> We couldn't find anything here. Get your creative skills out and help us fill this genre with your work :D </div>
        </div>
        <br/>
        <br/>
        <br/>
